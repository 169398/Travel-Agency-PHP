	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4>Our Vision</h4>
			 <p> Our vision is to become the foremost choice for travelers seeking unparalleled adventures, cultural immersion, and relaxation. We aim to be recognized as innovators in the travel industry, leveraging technology to enhance the booking process while maintaining the human touch that sets us apart. We envision a world where travel is not just a destination, but a transformative journey that enriches lives and fosters understanding among diverse cultures </p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4>Our Mission</h4>
			 <p>At our travel agency, our mission is to inspire and facilitate unforgettable journeys for our customers, connecting them with extraordinary destinations and experiences around the globe. We are committed to providing personalized service, expert guidance, and seamless travel arrangements, ensuring that every trip is tailored to exceed expectations and create cherished memories for a lifetime.</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4>Safety Information</h4>
			 <p>Your safety is our top priority. Our travel agency is dedicated to ensuring that all aspects of your journey are carefully planned and executed with your well-being in mind. We work only with reputable airlines, hotels, and tour operators that prioritize safety and adhere to rigorous standards. Additionally, we provide comprehensive travel insurance options to protect you against unforeseen circumstances.</p>
		 </div>
	 </div>
</div>
<!--/About-->
...
if(isset($_POST["sbmt"]))
{
	...
	echo "<script>alert(' Cornfirm to save the record');</script>";
}
?>
					  <form method="post">
