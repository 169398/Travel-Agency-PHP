		  ...
		  <div class="container">
			 <div class="top-nav">
						...
						<ul id="nav">
							 ...
							 <li><a href="login.php" onclick="javascript:window.open('login.php','_self')">User Login</a></li> 
							 <li><a href="home.php" onclick="javascript:window.open('login.php','_self')"> Log out</a></li> 
